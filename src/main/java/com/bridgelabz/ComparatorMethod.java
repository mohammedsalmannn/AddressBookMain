...
public class ComparatorMethod {
    public static Comparator<Address> nameComparator = new Comparator<Address>() {
        ...
        public int compare(Address addressOne, Address addrressTwo) {
            String Name1 = addressOne.getFirstname().toUpperCase();
            String Name2 = addrressTwo.getFirstname().toUpperCase();
